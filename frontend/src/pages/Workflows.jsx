    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Build visual automation workflows with a node-based editor</p>
        </div>
        <button
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg text-blue-600 hover:bg-blue-100 disabled:opacity-50 disabled:cursor-not-allowed"
                      title="Execute now"
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="font-medium text-gray-900">Meeting Processing</h4>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <span className="text-2xl">🔗</span>
              <h4 className="font-medium text-gray-900">Webhook to Slack</h4>
            </div>
            <p className="text-sm text-gray-500">
